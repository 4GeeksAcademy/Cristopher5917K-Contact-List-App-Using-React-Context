							...
							<div className="d-flex align-items-center col-12 col-md-7 gap-5">
								...
								<div className="ms-4">
									...
									<div className="d-flex justify-content-between">
										...
										<Link className="btn position" to={`/edit/contact/${item.id}`}><i className="fa-solid fa-pen edit-position"></i></Link>
									</div>

									<p className="contact-info p-3 contactColor"><i className="fa-solid fa-envelope"></i> {item.email}</p>
									<p className="contact-info fs-5 p-3 contactColor"><i className="fa-solid fa-location-dot"></i>{item.address}</p>
